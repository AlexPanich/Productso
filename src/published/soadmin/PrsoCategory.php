...
Admin::model(AlexPanich\productso\Models\PrsoCategory::class)->title('Категории товаров')->display(function ()
{
...
})->createAndEdit(function ()
{
	...
	$form->items([
		...
		FormItem::checkbox('showcontent', 'В списке категорий')->defaultValue(true),
